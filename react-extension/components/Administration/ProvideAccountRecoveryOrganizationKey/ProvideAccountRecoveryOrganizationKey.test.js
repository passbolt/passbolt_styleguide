...
describe("Provide Organization Key", () => {
  ...
  it("As AD, I should see an error message telling me that the provided ORK is not the expected one", async () => {
    ...
    expect(page.orkFieldError.textContent).toBe(
      `Error, this is not the current organization recovery key.Expected fingerprint:${formatFingerprint(expectedFingerprint)}`,
    );
  });
