      ...
      <div className="row">
        <div className="user-passphrase-policies-settings-teasing main-column">
          <div className="main-content">
            ...
            <p>
              <Trans>Enforce secure user passphrases to protect account access.</Trans>
            </p>
            <div className="user-passphrase-policies-info">
              <ul className="user-passphrase-policies-description">
                <li>
                  <RedCheck />
                  <Trans>Mitigate risks associated with weak passphrases.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Customise minimum length and complexity.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Improve overall user account security.</Trans>
                </li>
              </ul>
              <div>
                <a
        ...
        {createSafePortal(
          <>
            <div className="sidebar-help-section">
              ...
              <a
                className="button"
                href="https://www.passbolt.com/docs/admin/authentication/user-passphrase-policies/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <BuoySVG />
