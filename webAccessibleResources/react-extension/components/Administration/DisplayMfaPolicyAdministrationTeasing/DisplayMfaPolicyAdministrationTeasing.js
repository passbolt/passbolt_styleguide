      ...
      <div className="row">
        <div className="mfa-settings-teasing main-column">
          <div className="main-content">
            <h3 className="title" id="mfa-settings-title">
              <Trans>MFA Policy</Trans>
              <FrameSVG className="pro-teasing-icon" />
            </h3>
            <p>
              <Trans>Enhance security by enforcing multi-factor authentication.</Trans>
            </p>
            <div className="mfa-settings-info">
              <ul className="mfa-settings-description">
                <li>
                  <RedCheck />
                  <Trans>Strengthen user authentication.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Protect against unauthorised access.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Flexible configuration based on user roles or access levels.</Trans>
                </li>
              </ul>
              <div>
                <a
