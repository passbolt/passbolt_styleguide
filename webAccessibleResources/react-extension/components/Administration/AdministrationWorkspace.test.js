...
jest.mock("./DisplayPasswordPoliciesAdministration/DisplayPasswordPoliciesAdministration", () => () => (
  <span className="password-policies-details"></span>
));
jest.mock("./DisplaySecretHistoryAdministration/DisplaySecretHistoryAdministration", () => () => (
...
jest.mock("./DisplayEmailNotificationsAdministration/DisplayEmailNotificationsAdministration", () => () => (
  <span className="email-notifications-details"></span>
));
jest.mock("./DisplaySubscriptionKey/DisplaySubscriptionKey", () => () => (
  <span className="subscription-key-details"></span>
));
jest.mock("./DisplayInternationalizationAdministration/DisplayInternationalizationAdministration", () => () => (
  <span className="internationalization-details"></span>
));
jest.mock("./ManageAccountRecoveryAdministrationSettings/ManageAccountRecoveryAdministrationSettings", () => () => (
  <span className="account-recovery-details"></span>
));
jest.mock("./ManageSmtpAdministrationSettings/ManageSmtpAdministrationSettings", () => () => (
  <span className="smtp-settings-details"></span>
));
jest.mock("./DisplaySelfRegistrationAdministration/DisplaySelfRegistrationAdministration", () => () => (
  <span className="self-registration-details"></span>
));
jest.mock("./ManageSsoSettings/ManageSsoSettings", () => () => <span className="sso-settings-details"></span>);
jest.mock("./DisplayRbacAdministration/DisplayRbacAdministration", () => () => (
  <span className="rbacs-settings-details"></span>
));
jest.mock("./DisplayAdministrationUserPassphrasePolicies/DisplayAdministrationUserPassphrasePolicies", () => () => (
  <span className="user-passphrase-policies-details"></span>
));
jest.mock("./DisplayAdministrationPasswordExpiry/DisplayAdministrationPasswordExpiry", () => () => (
  <span className="password-expiry-details"></span>
));
jest.mock(
  "./DisplayContentTypesEncryptedMetadataAdministration/DisplayContentTypesEncryptedMetadataAdministration",
  () => () => <span className="content-types-encrypted-metadata"></span>,
);
jest.mock("./DisplayContentTypesMetadataKeyAdministration/DisplayContentTypesMetadataKeyAdministration", () => () => (
  <span className="content-types-metadata-key"></span>
));
jest.mock("./DisplayMigrateMetadataAdministration/DisplayMigrateMetadataAdministration", () => () => (
  <span className="migrate-metadata"></span>
));
jest.mock(
  "./DisplayContentTypesAllowedContentTypesAdministration/DisplayContentTypesAllowedContentTypesAdministration",
  () => () => <span className="allow-content-types"></span>,
);

jest.mock("./DisplayPasswordPoliciesAdministrationTeasing/DisplayPasswordPoliciesAdministrationTeasing", () => () => (
  <span className="password-policies-details-teasing"></span>
));
...
jest.mock(
  "./DisplayAdministrationUserPassphrasePoliciesTeasing/DisplayAdministrationUserPassphrasePoliciesTeasing",
  () => () => <span className="user-passphrase-policies-details-teasing"></span>,
);
jest.mock("./DisplayMfaPolicyAdministrationTeasing/DisplayMfaPolicyAdministrationTeasing", () => () => (
  <span className="mfa-policy-details-teasing"></span>
));
...
const scenarios = [
  ...
  {
    selectedMenu: AdministrationWorkspaceMenuTypes.CONTENT_TYPES_ENCRYPTED_METADATA,
    field: "isContentTypesEncryptedMetadataSelected",
  },
  {
    selectedMenu: AdministrationWorkspaceMenuTypes.CONTENT_TYPES_METADATA_KEY,
...
const ceScenarios = [
  ...
  { selectedMenu: AdministrationWorkspaceMenuTypes.RBAC, field: "isRbacSelected" },
  {
    selectedMenu: AdministrationWorkspaceMenuTypes.USER_PASSPHRASE_POLICIES,
    field: "isUserPasphrasePoliciesTeasingSelected",
  },
  { selectedMenu: AdministrationWorkspaceMenuTypes.PASSWORD_EXPIRY, field: "isPasswordExpirySelected" },
  {
    selectedMenu: AdministrationWorkspaceMenuTypes.CONTENT_TYPES_ENCRYPTED_METADATA,
