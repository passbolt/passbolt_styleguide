...
describe("See information", () => {
  ...
  const mockContextRequest = (implementation) =>
    jest.spyOn(props.context.port, "request").mockImplementationOnce(implementation);
  ...
  describe(" As LU I can see information of a resource", () => {
    ...
    beforeEach(() => {
      mockContextRequest(() =>
        defaultFolderDto(props.resourceWorkspaceContext.details.folder, { withCreator: true, withModifier: true }),
      );
