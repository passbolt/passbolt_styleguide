...
class OAuth2SsoSettingsFormEntity extends EntityV2 {
  ...
  /**
   * Clone the current entity and modify the clone with the given value on the given field.
   * @param {string} field the field to change
   * @param {unknown} value the value to apply on the field
   * @returns {OAuth2SsoSettingsFormEntity} the cloned entity with the field modified
   */
  cloneWithMutation(field, value) {
    const dto = { ...this._props };
    dto[field] = value;
    return new OAuth2SsoSettingsFormEntity(dto);
  }
