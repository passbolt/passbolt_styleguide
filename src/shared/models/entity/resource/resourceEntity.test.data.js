...
export const defaultResourceDto = (data = {}, options = {}) => {
  ...
  const defaultData = {
    id: id,
    resource_type_id:
      data?.metadata?.resource_type_id || data?.resource_type_id || TEST_RESOURCE_TYPE_PASSWORD_AND_DESCRIPTION,
    expired: null,
    deleted: false,
...
export const resourceLegacyDto = (data = {}, options = {}) =>
  defaultResourceDto(
    {
...
export const resourceWithTotpDto = (data = {}, options = {}) =>
  defaultResourceDto(
    {
...
export const resourceStandaloneTotpDto = (data = {}, options = {}) =>
  defaultResourceDto(
    {
...
export const resourceExpiredDto = (data = {}, options = {}) =>
  defaultResourceDto(
    {
