...
/**
 * Model related to the column tags use only with the UI
 */
class ColumnTagsModel extends ColumnModel {
  /**
   * Constructor
   * @param {Object} columnDto
   */
  constructor(columnDto = {}) {
    columnDto.id = ColumnModelTypes.TAGS;
...
export default ColumnTagsModel;
