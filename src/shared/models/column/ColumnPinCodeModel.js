...
/**
 * Model related to the column pin code use only with the UI
 */
class ColumnPinCodeModel extends ColumnModel {
  /**
   * Constructor
   * @param {Object} columnDto
   */
  constructor(columnDto = {}) {
    columnDto.id = ColumnModelTypes.PIN_CODE;
...
export default ColumnPinCodeModel;
