      ...
      <div>
        ...
        <DialogWrapper className='ldap-simulate-synchronize-dialog' title="Synchronize simulation report"
          ...
          <div className="form-content" onSubmit={this.handleFormSubmit}>
            ...
            <p className="error inline-error">Some resources won't be synchronized and will require your attention, see the full report.</p>
            }
...
export default withActionFeedback(DisplaySimulateSynchronizeUserDirectoryAdministrationDialog);
