...
export const domElementLoginWithNameAttributeUsername =
  "<div>" + '  <input type="text" name="username"/>' + '  <input type="password"/>' + "</div>";
 ...
 * @type {string}
 */
export const domElementOnlyUsername = "<div>" + '  <input type="text" name="username"/>' + "</div>";

/**
 * Create a login form with only password in DOM
 * @type {string}
 */
export const domElementOnlyPassword = "<div>" + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNameAttributeEmail =
  "<div>" + '  <input type="text" name="email"/>' + '  <input type="text" name="password"/>' + "</div>";
...
export const domElementLoginWithNameAttributeLogin =
  "<div>" + '  <input type="text" name="form_login"/>' + '  <input type="text" name="password"/>' + "</div>";
...
export const domElementLoginWithNameAttributeLogto =
  "<div>" + '  <input type="text" name="logto"/>' + '  <input type="text" name="password"/>' + "</div>";
...
export const domElementLoginWithNameAttributeBenutzerkennung =
  "<div>" + '  <input type="text" name="form_benutzerkennung"/>' + '  <input type="text" name="password"/>' + "</div>";
...
export const domElementLoginWithNameAttributeBenutzername =
  "<div>" + '  <input type="text" name="form_benutzername"/>' + '  <input type="text" name="password"/>' + "</div>";
...
export const domElementLoginWithNameAttributeBenutzernameAndPasswordAttributePasswort =
  "<div>" + '  <input type="text" name="form_benutzername"/>' + '  <input type="text" name="passwort"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndNameAttributeUsername =
  "<div>" + '  <input name="username"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndNameAttributeEmail =
  "<div>" + '  <input name="email"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndNameAttributeLogin =
  "<div>" + '  <input name="Login"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndNameAttributeBenutzerkennung =
  "<div>" + '  <input name="Benutzerkennung"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndNameAttributeBenutzername =
  "<div>" + '  <input name="Benutzername"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithClassUsername =
  "<div>" + '  <input type="text" class="username"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithClassEmail =
  "<div>" + '  <input type="text" class="email"/>' + '  <input type="text" class="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndClassUsername =
  "<div>" + '  <input class="username"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndClassEmail =
  "<div>" + '  <input class="email"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndClassCreateAccount =
  "<div>" + '  <input class="create-account-input"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithIdAttributeUsername =
  "<div>" + '  <input type="text" id="username"/>' + '  <input type="text" id="password"/>' + "</div>";
...
export const domElementLoginWithIdAttributeEmail =
  "<div>" + '  <input type="text" id="YahooEmail"/>' + '  <input type="text" id="YahooPassword"/>' + "</div>";
...
export const domElementLoginWithIdAttributeLogin =
  "<div>" + '  <input type="text" id="Test_Ploginutg"/>' + '  <input type="text" id="YahooPassword"/>' + "</div>";
...
export const domElementLoginWithIdAttributeLogto =
  "<div>" + '  <input type="text" id="logto"/>' + '  <input type="text" id="password"/>' + "</div>";
...
export const domElementLoginWithIdAttributeBenutzerkennung =
  "<div>" + '  <input type="text" id="Test_Pbenutzerkennungutg"/>' + '  <input type="text" id="Password"/>' + "</div>";
...
export const domElementLoginWithIdAttributeBenutzername =
  "<div>" + '  <input type="text" id="Test_Pbenutzernameutg"/>' + '  <input type="text" id="Password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndIdAttributeUsername =
  "<div>" + '  <input id="username-Y"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndIdAttributeEmail =
  "<div>" + '  <input id="Email-Y"/>' + '  <input type="text" id="password-Y"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndIdAttributeLogin =
  "<div>" + '  <input id="login-Y"/>' + '  <input type="text" id="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndIdAttributeBenutzerkennung =
  "<div>" + '  <input id="benutzerkennung-Y"/>' + '  <input type="text" id="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndIdAttributeBenutzername =
  "<div>" + '  <input id="benutzername-Y"/>' + '  <input type="text" id="password"/>' + "</div>";
...
export const domElementLoginWithAutocompleteAttributeUsername =
  "<div>" + '  <input type="text" autocomplete="USERNAME"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithAutocompleteAttributeEmail =
  "<div>" + '  <input type="text" autocomplete="Email"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndAutocompleteAttributeUsername =
  "<div>" + '  <input autocomplete="USERNAME"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndAutocompleteAttributeEmail =
  "<div>" + '  <input autocomplete="Email"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithPlaceHolderAttributeUsername =
  "<div>" + '  <input type="Text" placeholder="Username"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithPlaceHolderAttributeEmail =
  "<div>" + '  <input type="TEXT" placeholder="email"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithPlaceHolderAttributeE_mail =
  "<div>" + '  <input type="Text" placeholder="e-mail"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndPlaceHolderAttributeUsername =
  "<div>" + '  <input placeholder="Username"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndPlaceHolderAttributeEmail =
  "<div>" + '  <input placeholder="email"/>' + '  <input type="password"/>' + "</div>";
...
export const domElementLoginWithNoTypeAndPlaceHolderAttributeE_mail =
  "<div>" + '  <input placeholder="The-mailO"/>' + '  <input type="password"/>' + "</div>";
