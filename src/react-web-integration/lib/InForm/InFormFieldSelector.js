...
export default {
  ...
  input[type='text'][autocomplete*='user']:not([hidden]):not([disabled]),
  input[type='text'][autocomplete*='email']:not([hidden]):not([disabled]),
  ...
  input[autocomplete*='user']:not([type]):not([hidden]):not([disabled]),
  input[autocomplete*='email']:not([type]):not([hidden]):not([disabled])`,
