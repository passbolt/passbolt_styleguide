...
describe("AccountRecoveryUser Context", () => {
  const organizationAccountRecoveryPolicy = {
    policy: 'opt-out',
  ...
  it('should called the given accountRecoveryUserService and be able to give back the data to the context consumers', async() => {
    ...
    expect(component.getRequestor()).toBe(organizationAccountRecoveryPolicy.creator);
    ...
    expect(component.getOrganizationPolicy()).toBe(organizationAccountRecoveryPolicy);
  });
