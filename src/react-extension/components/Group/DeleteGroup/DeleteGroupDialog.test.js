...
import {defaultAppContext, defaultProps, mockGroup} from "./DeleteGroupDialog.test.data";
import DeleteGroupDialogTestPage from "./DeleteGroupDialog.test.page";
...
describe("See Delete Group Dialog", () => {
  ...
  describe('As AD I can delete a group', () => {
    ...
    beforeEach(() => {
      ...
      page = new DeleteGroupDialogTestPage(context, props);
    });
    ...
    it('As AD I should know what group I am deleting', () => {
      ...
      expect(page.displayDeleteGroupDialog.saveButton.value).toBe('Delete');
      // cancel button
    ...
    it('As AD I should see a processing feedback while submitting the form', async() => {
      ...
      await waitFor(() => {
        expect(page.displayDeleteGroupDialog.cancelButtonDisabled).not.toBeNull();
        expect(page.displayDeleteGroupDialog.saveButton.getAttribute("disabled")).not.toBeNull();
