...
describe("See information", () => {
  ...
  describe(' As LU I can see information of a resource', () => {
    ...
    it('I should be able to identify each information name', async() => {
      ...
      expect(page.displayInformationList.modified(1).textContent).toBe(formatDateTimeAgo(props.resourceWorkspaceContext.details.resource.modified));
      ...
      expect(page.displayInformationList.modified(2).textContent).toBe(formatDateTimeAgo(props.resourceWorkspaceContext.details.resource.modified));
