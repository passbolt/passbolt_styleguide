...
import ChooseAccountRecoveryPreference from "../../Authentication/ChooseAccountRecoveryPreference/ChooseAccountRecoveryPreference";
  ...
  render() {
    switch (this.props.authenticationSetupContext.state) {
      ...
      case AuthenticationSetupWorkflowStates.CHOOSE_SECURITY_TOKEN:
        return <ChooseSecurityToken onComplete={this.props.authenticationSetupContext.chooseSecurityToken} />;
      case AuthenticationSetupWorkflowStates.CONFIGURING_SSO:
        return <LoadingSpinner title={<Trans>Configuring SSO access, please wait...</Trans>} />;
      case AuthenticationSetupWorkflowStates.COMPLETING_SETUP:
        return <LoadingSpinner title={<Trans>Completing setup, please wait...</Trans>} />;
      ...
      case AuthenticationSetupWorkflowStates.UNEXPECTED_ERROR:
        return <DisplayUnexpectedError error={this.props.authenticationSetupContext.error} />;
      case AuthenticationSetupWorkflowStates.UNEXPECTED_METADATA_ENCRYPTION_ENABLEMENT_ERROR:
        return (
          <DisplayMetadataEnablementError
      ...
      case AuthenticationSetupWorkflowStates.CHECKING_POST_SETUP_METADATA_TASKS:
        return <LoadingSpinner title={<Trans>Checking resource types post-account-activation tasks.</Trans>} />;
      case AuthenticationSetupWorkflowStates.ENABLING_METADATA_ENCRYPTION:
        return <LoadingSpinner title={<Trans>Enabling encrypted resource metadata.</Trans>} />;
