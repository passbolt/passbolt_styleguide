  ...
  <ContextualMenuWrapper hide={() => {}}>
      ...
      <div className="row">
        <div className="main-cell-wrapper">
          <div className="main-cell">
            <button type="button" className="link no-border" id="username">
              <OwnedByMeIcon />
              <span>
    ...
    <li key="option-copy-password-resource" className="ready separator-after">
      <div className="row">
        <div className="main-cell-wrapper">
          <div className="main-cell">
            <button type="button" className="link no-border" id="password">
              <KeyIcon />
              <span>
    ...
    <li key="option-mark-as-expired" className="ready separator-after">
      <div className="row">
        <div className="main-cell-wrapper">
          <div className="main-cell">
            <button type="button" className="link no-border" id="permalink">
              <ClockIcon />
              <span>
