...
/**
 * Unit tests on DisplayUserIntroductionPassphrase in regard of specifications
 */
import DisplayUserIntroductionPassphrasePage from "./DisplayUserIntroductionPassphrase.test.page";
import {defaultProps} from "./DisplayUserIntroductionPassphrase.test.data";
...
describe("As LU I should see the user introduction passphrase page", () => {
  ...
  describe('As LU I can start to update the passphrase', () => {
     ...
     */
    beforeEach(() => {
      page = new DisplayUserIntroductionPassphrasePage(context, props);
    });
