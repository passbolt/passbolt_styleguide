...
import DisplayUserIntroductionPassphrase from "./DisplayUserIntroductionPassphrase";
import AppContext from "../../../contexts/AppContext";

/**
 * The DisplayUserIntroductionPassphrase component represented as a page
 */
export default class DisplayUserIntroductionPassphrasePage {
  /**
   * Default constructor
  ...
  constructor(appContext, props) {
    this._page = render(
      <AppContext.Provider value={appContext}>
        <DisplayUserIntroductionPassphrase {...props}/>
      </AppContext.Provider>
    );
  }
   ...
   */
  get displayUserIntroductionPassphrase() {
   ...
   */
  exists() {
    return this.displayUserIntroductionPassphrase !== null;
  }
