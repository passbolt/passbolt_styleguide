...
/**
 * Unit tests on DisplayUserDownloadRecoveryKit in regard of specifications
 */
import DisplayUserDownloadRecoveryKitPage from "./DisplayUserDownloadRecoveryKit.test.page";
import {defaultProps} from "./DisplayUserDownloadRecoveryKit.test.data";
...
describe("As LU I should see the user confirm passphrase page", () => {
  ...
  describe('As LU I can start to download the recovery kit', () => {
     ...
     */
    beforeEach(() => {
      page = new DisplayUserDownloadRecoveryKitPage(props);
    });
