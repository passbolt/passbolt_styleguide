...
import DisplayUserDownloadRecoveryKit from "./DisplayUserDownloadRecoveryKit";

/**
 * The DisplayUserDownloadRecoveryKit component represented as a page
 */
export default class DisplayUserDownloadRecoveryKitPage {
  /**
   * Default constructor
  ...
  constructor(props) {
    this._page = render(
      <DisplayUserDownloadRecoveryKit {...props}/>
    );
  }
   ...
   */
  get displayUserDownloadRecoveryKit() {
   ...
   */
  exists() {
    return this.displayUserDownloadRecoveryKit !== null;
  }
