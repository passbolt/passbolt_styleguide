...
/**
 * Unit tests on DisplayUserChoosePassphrase in regard of specifications
 */
import DisplayUserChoosePassphrasePage from "./DisplayUserChoosePassphrase.test.page";
import {defaultProps} from "./DisplayUserChoosePassphrase.test.data";
...
describe("As LU I should see the user confirm passphrase page", () => {
  ...
  describe('As LU I can start confirm my passphrase', () => {
     ...
     */
    beforeEach(() => {
      page = new DisplayUserChoosePassphrasePage(props);
    });
