 ...
 */
class DisplayUserChoosePassphrase extends React.Component {
  /**
   * Default constructor
          ...
          <div className="col6">
            <form className="enter-passphrase" onSubmit={this.handleSubmit}>
              ...
              <div className="submit-wrapper">
                ...
                <FormSubmitButton big={true} disabled={this.mustBeDisabled || this.isProcessing} processing={this.isProcessing} value="Update"/>
              </div>
            </form>
          </div>
...
DisplayUserChoosePassphrase.propTypes = {
  userSettingsContext: PropTypes.object, // The user settings context
  dialogContext: PropTypes.any, // The dialog context
};

export default withDialog(withUserSettings(DisplayUserChoosePassphrase));
