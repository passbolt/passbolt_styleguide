...
import DisplayUserPassphrase from "./DisplayUserPassphrase";

/**
 * The DisplayUserPassphrase component represented as a page
 */
export default class DisplayUserPassphrasePage {
  /**
   * Default constructor
