...
import DisplayUserConfirmPassphrase from "./DisplayUserConfirmPassphrase";

/**
 * The DisplayUserConfirmPassphrase component represented as a page
 */
export default class DisplayUserConfirmPassphrasePage {
  /**
   * Default constructor
  ...
  constructor(props) {
    this._page = render(
      <DisplayUserConfirmPassphrase {...props}/>
    );
  }
   ...
   */
  get displayUserConfirmPassphrase() {
   ...
   */
  exists() {
    return this.displayUserConfirmPassphrase !== null;
  }
