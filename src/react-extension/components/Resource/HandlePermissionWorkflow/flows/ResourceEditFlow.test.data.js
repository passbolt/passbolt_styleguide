 ...
 * @param {Object} [data] The overrides (e.g. `permission.type` to simulate update vs owner access).
 * @returns {object}
 */
...
/**
 * Default props for the ResourceEditFlow component.
 * @param {Object} [props] The overrides.
 * @returns {object}
 */
export function defaultProps(props = {}) {
  const _props = {
    resource: resourceDto(props?.resource),
