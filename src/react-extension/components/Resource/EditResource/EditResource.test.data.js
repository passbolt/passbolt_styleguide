...
export function defaultProps() {
  ...
  const passwordGeneratorSettings = defaultSecretConfigurationSettings();
  ...
  return {
    ...
    resourcePasswordGeneratorContext: {
      ...
      getCurrentGenerator: () => passwordGeneratorSettings.generators.find(g => g.type === "password"),
      getGeneratorForType: type => passwordGeneratorSettings.generators.find(g => g.type === type),
      changeGenerator: () => {}
    },
    onClose: () => {},
    dialogContext: {
