          ...
          <div className="form-content">
            <div className={`input file ${this.hasAllInputDisabled() ? "disabled" : ""} ${invalidFileClassName}`}>
              ...
              <label htmlFor="dialog-import-passwords">
                ...
                <Tooltip message={this.translate("csv exports from browsers (safari, chrome, edge, brave, opera, vivaldi, firefox, waterfox), keepassx, lastpass, 1password, dashlane and bitwarden are supported")}>
                  (<a role="link">csv</a>
                </Tooltip>
                &nbsp;{this.translate("or")}&nbsp;
