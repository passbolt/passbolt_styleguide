        ...
        <form onSubmit={this.handleSubmit}>
          <div className="form-content">
            <div className={`input file ${this.hasAllInputDisabled() ? "disabled" : ""} ${invalidFileClassName}`}>
              ...
              <label htmlFor="dialog-import-passwords">
                ...
                <Tooltip
                  message={this.translate(
                    "csv exports from browsers (safari, chrome, edge, brave, opera, vivaldi, firefox, waterfox), keepassx, logmeonce, lastpass, 1password, nordpass, dashlane and bitwarden are supported",
                  )}
                >
                  (
              ...
              {isInvalidCsvFile && <div className="error-message">{this.state.errors.invalidCsvFile}</div>}
              {isInvalidKdbxFile && <div className="error-message">{this.state.errors.invalidKdbxFile}</div>}
            </div>
            ...
            {this.canUseTags && (
              <div className="input checkbox">
                ...
                />
                <label htmlFor="dialog-import-passwords-import-tags">
                  <Trans>Add a unique import tag to passwords</Trans>
                </label>
              </div>
            )}
            ...
            {this.canUseFolders && (
              <div className="input checkbox">
                ...
                />
                <label htmlFor="dialog-import-passwords-import-folders">
                  <Trans>Import folders</Trans>
                </label>
              </div>
            )}
              ...
              <p>
                <span>
                  <Trans>
                    Checkout the{" "}
                    <a
                      href="https://www.passbolt.com/docs/user/basic-features/browser/import/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      documentation
                    </a>{" "}
                    to see what information is supported.
                  </Trans>
                </span>
              </p>
            </div>
...
export default withAppContext(
  withRbac(withResourceWorkspace(withActionFeedback(withDialog(withTranslation("common")(ImportResources))))),
);
