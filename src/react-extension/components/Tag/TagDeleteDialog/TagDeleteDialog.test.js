...
import TagDeleteDialogPage from "./TagDeleteDialog.test.page";
import {defaultAppContext, defaultProps} from "./TagDeleteDialog.test.data";
...
describe("See the Delete Tag Dialog", () => {
  ...
  describe('As LU I can start deleting a tag', () => {
    ...
    beforeEach(() => {
      ...
      page = new TagDeleteDialogPage(context, props);
    });
