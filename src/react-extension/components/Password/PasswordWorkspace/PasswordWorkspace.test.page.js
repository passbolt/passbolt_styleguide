 ...
 */
export default class PasswordWorkspacePage {
  /**
   * Default constructor
   ...
   */
  setupPageObjects() {
    this._displayPasswordWorkspace = new DisplayPasswordWorkspacePageObject(this._page.container);
  }

  /**
   * Returns the page object of display PasswordWorkspace
   */
  get displayPasswordWorkspace() {
    return this._displayPasswordWorkspace;
  }
}
 ...
 */
class DisplayPasswordWorkspacePageObject {
  /**
   * Default constructor
