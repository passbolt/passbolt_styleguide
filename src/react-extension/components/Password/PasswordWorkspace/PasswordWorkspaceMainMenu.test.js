...
import {
  defaultAppContext, defaultAppContextProEdition,
  defaultPropsFolderNotOwned,
  defaultPropsFolderOwned, defaultPropsNoFolder
} from "./PasswordWorkspaceMainMenu.test.data";
import PasswordWorkspaceMainMenuPage from "./PasswordWorkspaceMainMenu.test.page";
...
describe("See Workspace Main Menu", () => {
  ...
  describe('As LU I can start adding a resource via the workspace main menu', () => {
    ...
    beforeEach(() => {
      page = new PasswordWorkspaceMainMenuPage(context, propsFolderOwned);
    });
  ...
  describe('As LU I can see the workspace menu with one folder selected not owned', () => {
    ...
    beforeEach(() => {
      page = new PasswordWorkspaceMainMenuPage(context, propsFolderNotOwned);
    });
  ...
  describe('As LU I can see the workspace menu with no folder selected', () => {
    ...
    beforeEach(() => {
      page = new PasswordWorkspaceMainMenuPage(context, propsNoFolder);
    });
  ...
  describe('As LU I can start adding a resource via the workspace main menu PRO edition', () => {
    ...
    beforeEach(() => {
      page = new PasswordWorkspaceMainMenuPage(contextPro, propsFolderOwned);
    });
