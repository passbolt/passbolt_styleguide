 ...
 */
export default class PasswordDeleteDialogPage {
  /**
   * Default constructor
   ...
   */
  setupPageObjects() {
    this._displayPasswordDeleteDialog = new PasswordDeleteDialogPageObject(this._page.container);
  }

  /**
   * Returns the page object of display comments
   */
  get displayPasswordDeleteDialog() {
    return this._displayPasswordDeleteDialog;
  }
}
 ...
 */
class PasswordDeleteDialogPageObject {
  /**
   * Default constructor
