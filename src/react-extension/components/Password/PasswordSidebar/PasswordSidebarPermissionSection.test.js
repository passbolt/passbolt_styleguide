...
/**
 * Unit tests on PasswordSidebarPermissionSection in regard of specifications
 */
...
} from "./PasswordSidebarPermissionSection.test.data";
import PasswordSidebarPermissionSectionPage from "./PasswordSidebarPermissionSection.test.page";
...
describe("See permissions", () => {
  ...
  describe(' As LU I can see permissions of a resource with at least one permission', () => {
    ...
    beforeEach(() => {
      page = new PasswordSidebarPermissionSectionPage(context, props);
