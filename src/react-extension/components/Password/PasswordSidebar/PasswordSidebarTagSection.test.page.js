...
export default class PasswordSidebarTagSectionPage {
  ...
  setupPageObjects() {
    ...
    this._tagEditor = new TagEditorPageObject(this._page.container);
    this._tagItemViewer = new TagItemViewerPageObject(this._page.container);
  }
...
class PasswordSidebarTagSectionPageObject {
   ...
   */
  get editIcon() {
    return this._container.querySelector('.edit_tags_button.section-action span');
  }
