...
import {
  defaultAppContext,
  defaultProps,
} from "./FoldersTreeRootFolderContextualMenu.test.data";
import FoldersTreeRootFolderContextualMenuPage from "./FoldersTreeRootFolderContextualMenu.test.page";
...
describe("As LU I should see each menu", () => {
  ...
  describe('As LU I should see and identify each menu for a folder', () => {
    ...
    beforeEach(() => {
      page = new FoldersTreeRootFolderContextualMenuPage(context, props);
    });
