...
import {
  defaultAppContext,
  defaultProps,
} from "./FolderSidebarInformationSection.test.data";
import FolderSidebarInformationSectionPage from "./FolderSidebarInformationSection.test.page";
...
describe("See information", () => {
  ...
  describe(' As LU I can see information of a resource', () => {
    ...
    beforeEach(() => {
      page = new FolderSidebarInformationSectionPage(context, props);
    });
