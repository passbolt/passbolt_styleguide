...
export default {
  title: 'Passbolt/Password/FolderSidebarInformationSection',
  component: FolderSidebarInformationSection
};
...
const Template = args =>
  <AppContext.Provider value={context}>
    <MemoryRouter initialEntries={['/']}>
      <Route component={routerProps => <FolderSidebarInformationSection {...args} {...routerProps}/>}></Route>
    </MemoryRouter>
  </AppContext.Provider>;
