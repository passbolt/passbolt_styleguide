...
/**
 * The FolderSidebarActivitySection component represented as a page
 */
export default class FolderSidebarActivitySectionPage {
  /**
   * Default constructor
    ...
    this._page = render(
      <Router>
        <AppContext.Provider value={appContext}>
          <FolderSidebarActivitySection {...props}/>
        </AppContext.Provider>
      </Router>
    );
