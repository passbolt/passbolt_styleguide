...
export default {
  title: 'Passbolt/Password/FolderSidebarPermissionsSection',
  component: FolderSidebarPermissionsSection
};
...
const Template = args =>
  <AppContext.Provider value={context}>
    <MemoryRouter initialEntries={['/']}>
      <Route component={routerProps => <FolderSidebarPermissionsSection {...args} {...routerProps}/>}></Route>
    </MemoryRouter>
  </AppContext.Provider>;
