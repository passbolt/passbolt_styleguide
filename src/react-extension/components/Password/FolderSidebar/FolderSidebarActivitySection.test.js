...
/**
 * Unit tests on FolderSidebarActivitySection in regard of specifications
 */
...
import {
  ...
  defaultProps,
  lastActivityMock
} from "./FolderSidebarActivitySection.test.data";
import FolderSidebarActivitySectionPage from "./FolderSidebarActivitySection.test.page";
...
describe("See activities", () => {
  ...
  describe(' As LU I can see activities of a resource with at least one activity', () => {
    ...
    beforeEach(() => {
      page = new FolderSidebarActivitySectionPage(context, props);
