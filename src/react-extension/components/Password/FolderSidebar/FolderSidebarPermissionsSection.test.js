...
} from "./FolderSidebarPermissionsSection.test.data";
import FolderSidebarPermissionSectionPage from "./FolderSidebarPermissionsSection.test.page";
...
describe("See permissions", () => {
  ...
  describe(' As LU I can see permissions of a resource with at least one permission', () => {
    ...
    beforeEach(() => {
      page = new FolderSidebarPermissionSectionPage(context, props);
