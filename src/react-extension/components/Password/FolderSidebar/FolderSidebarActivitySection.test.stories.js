...
export default {
  title: 'Passbolt/Password/FolderSidebarActivitySection',
  component: FolderSidebarActivitySection
};
...
const Template = args =>
  <AppContext.Provider value={context}>
    <MemoryRouter initialEntries={['/']}>
      <Route component={routerProps => <FolderSidebarActivitySection {...args} {...routerProps}/>}></Route>
    </MemoryRouter>
  </AppContext.Provider>;
