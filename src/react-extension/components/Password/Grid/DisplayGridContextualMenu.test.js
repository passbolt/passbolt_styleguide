...
} from "./DisplayGridContextualMenu.test.data";
import DisplayGridContextualMenuPage from "./DisplayGridContextualMenu.test.page";
...
describe("As LU I should see each menu", () => {
  ...
  describe('As LU I should see and identify each menu for a resource', () => {
    ...
    beforeEach(() => {
      page = new DisplayGridContextualMenuPage(context, props);
    });
    ...
    it('As LU I can start to edit a resource', async() => {
      await page.edit();
      expect(props.dialogContext.open).toHaveBeenCalledWith(PasswordEditDialog);
      expect(props.hide).toHaveBeenCalled();
    });
    ...
    it('As LU I can start to delete a resource', async() => {
      await page.delete();
      expect(props.dialogContext.open).toHaveBeenCalledWith(PasswordDeleteDialog);
      expect(props.hide).toHaveBeenCalled();
    });
  });
