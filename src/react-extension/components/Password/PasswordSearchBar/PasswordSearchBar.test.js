...
/**
 * Unit tests on PasswordSearchBar in regard of specifications
 */


import {
  defaultAppContext, defaultProps,
} from "./PasswordSearchBar.test.data";
import PasswordSearchBarPage from "./PasswordSearchBar.test.page";
...
describe("See Resource SearchBar", () => {
  ...
  describe(' As LU I can see a search bar', () => {
    ...
    beforeEach(() => {
      page = new PasswordSearchBarPage(context, props);
    });
