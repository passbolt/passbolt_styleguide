...
/**
 * Unit tests on PasswordBreadcrumb in regard of specifications
 */


import {
  defaultAppContext, defaultResourceWorkspaceContext,
} from "./Passwordbreadcrumb.test.data";
import PasswordBreadcrumbPage from "./PasswordBreadcrumb.test.page";
