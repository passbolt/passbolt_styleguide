...
import PasswordUnlockKeypassDialogPage from "./PasswordUnlockKeypassDialog.test.page";
import {defaultAppContext, defaultProps} from "./PasswordUnlockKeypassDialog.test.data";
...
describe("As LU I should see the password unlock Keypass dialog", () => {
  ...
  describe('As LU I can start unlock Keypass a file', () => {
     ...
     */
    beforeEach(() => {
      page = new PasswordUnlockKeypassDialogPage(context, props);
    });
    ...
    it('As LU I see a success dialog after unlocking keypass file with success', async() => {
      ...
      expect(props.dialogContext.open).toHaveBeenCalledWith(PasswordImportResultDialog);
