        ...
        <form onSubmit={this.handleSubmit}>
          <div className="form-content">
            <div className="input-file-chooser-wrapper">
              ...
              <div className={`input text required ${invalidFileClassName}`}>
                <label htmlFor="dialog-import-passwords">
                  {this.translate("Select a file to import")}
            ...
            <div className="input text">
              ...
              <label htmlFor="dialog-import-passwords-import-tags"> {this.translate("Add a unique import tag to passwords")}</label>
            </div>
            }
            ...
            <div className="input text">
              ...
              <label htmlFor="dialog-import-passwords-import-folders"> {this.translate("Import folders")}</label>
            </div>
            }
          </div>
...
export default withResourceWorkspace(withActionFeedback(withDialog(withTranslation('common')(PasswordImportDialog))));
