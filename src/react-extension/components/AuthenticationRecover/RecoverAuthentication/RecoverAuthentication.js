...
import AskForAuthenticationHelpCredentialLost, {
  AskForAuthenticationHelpCredentialLostVariations,
} from "../../Authentication/AskForAuthenticationHelpCredentialLost/AskForAuthenticationHelpCredentialLost";
  ...
  render() {
    switch (this.props.authenticationRecoverContext.state) {
      ...
      case AuthenticationRecoverWorkflowStates.CHOOSE_SECURITY_TOKEN:
        return (
          <ChooseSecurityToken onComplete={this.props.authenticationRecoverContext.chooseSecurityToken.bind(this)} />
        );
      ...
      case AuthenticationRecoverWorkflowStates.COMPLETING_RECOVER:
        return <LoadingSpinner title={<Trans>Completing recover. Please wait...</Trans>} />;
      case AuthenticationRecoverWorkflowStates.HELP_CREDENTIALS_LOST:
        return (
          <AskForAuthenticationHelpCredentialLost
      ...
      case AuthenticationRecoverWorkflowStates.REQUESTING_ACCOUNT_RECOVERY:
        return <LoadingSpinner title={<Trans>Requesting administrator approval. Please wait...</Trans>} />;
      ...
      case AuthenticationRecoverWorkflowStates.UNEXPECTED_ERROR:
        return <DisplayUnexpectedError error={this.props.authenticationRecoverContext.error} />;
