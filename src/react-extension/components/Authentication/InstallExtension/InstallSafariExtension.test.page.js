...
import InstallSafariExtension from "./InstallSafariExtension";

/**
 * The InstallSafariExtension component represented as a page
 */
export default class InstallSafariExtensionTestPage {
  /**
   * Default constructor
   ...
   */
  get browserClassName() {
    return this._page.container.querySelector(".install-extension a").className;
  }
