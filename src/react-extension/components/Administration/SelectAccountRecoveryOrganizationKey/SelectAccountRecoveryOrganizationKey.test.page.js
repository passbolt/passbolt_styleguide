...
export default class SelectAccountRecoveryOrganizationKeyPage {
  ...
  get imoprtKeyTitle() {
    return this._page.container.querySelector(
      '.organization-recover-key-dialog.dialog-wrapper .form-content.import-organization-key label[for="organization-recover-form-key"]',
    );
  }
  ...
  get importKeyTextArea() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.import-organization-key #organization-recover-form-key",
    );
  }
  ...
  get browseInput() {
    return this._page.container.querySelector(
      '.organization-recover-key-dialog.dialog-wrapper .form-content.import-organization-key input[type="file"]',
    );
  }
  ...
  get proTipDescription() {
    return this._page.container.querySelector(".organization-recover-key-dialog.dialog-wrapper .message.notice")
      .textContent;
  }
  ...
  get proTipLink() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .message.notice a[href]",
    );
  }
  ...
  get applyButton() {
    return this._page.container.querySelector(
      '.organization-recover-key-dialog.dialog-wrapper .submit-wrapper button[type="submit"]',
    );
  }
  ...
  get importErrorMessage() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.import-organization-key .error-message",
    );
  }
  ...
  get showPassphraseButton() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key .password-view",
    );
  }
  ...
  get showPassphraseConfirmationButton() {
    return this._page.container.querySelector(
      "#generate-organization-key-form-password-confirmation + .password-view-wrapper .password-view",
    );
  }
  ...
  get securityToken() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key .security-token",
    );
  }
  ...
  get passphraseStrength() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key .password-complexity .complexity-text",
    );
  }
   ...
   */
  get generateTab() {
    return this._page.container.querySelectorAll(".organization-recover-key-dialog.dialog-wrapper .tabs .tab button")[
      GENERATE_TAB_INDEX
    ];
  }
  ...
  get algorithmTooltip() {
    return this._page.container.querySelector(
      '.organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key [for="generate-organization-key-form-algorithm"] .tooltip .tooltip-text',
    );
  }
  ...
  get keySizeTooltip() {
    return this._page.container.querySelector(
      '.organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key [for="generate-organization-key-form-keySize"] .tooltip .tooltip-text',
    );
  }
  ...
  get nameFieldError() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key .name.error-message",
    );
  }
  ...
  get emailFieldError() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key .email.error-message",
    );
  }
  ...
  get passphraseFieldError() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key .password.error-message",
    );
  }
  ...
  get passphraseConfirmationFieldError() {
    return this._page.container.querySelector(
      ".organization-recover-key-dialog.dialog-wrapper .form-content.generate-organization-key .password-confirmation.error-message",
    );
  }
  ...
  isImportKeyTabSelected() {
    return (
      this._page.container.querySelector(
        ".organization-recover-key-dialog.dialog-wrapper .tabs-active-content form .import-organization-key",
      ) !== null
    );
  }
  ...
  isGenerateTabSeletect() {
    return (
      this._page.container.querySelector(
        ".organization-recover-key-dialog.dialog-wrapper .tabs-active-content .generate-organization-key",
      ) !== null
    );
  }
