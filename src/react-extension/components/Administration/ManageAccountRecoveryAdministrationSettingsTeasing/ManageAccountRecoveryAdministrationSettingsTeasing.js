      ...
      <div className="row">
        <div className="recover-account-settings-teasing main-column">
          <div className="main-content">
            <h3 className="title" id="recover-account-settings-title">
              <Trans>Account Recovery</Trans>
              <FrameSVG className="pro-teasing-icon" />
            </h3>
            <p>
              <Trans>Recover lost user accounts.</Trans>
            </p>
            <div className="recover-account-info">
              <ul className="recover-account-description">
                <li>
                  <RedCheck />
                  <Trans>In case of passphrase loss.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>In case of private key loss.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Configurable with an Organisation Recovery Key.</Trans>
                </li>
              </ul>
              <div>
                <a
