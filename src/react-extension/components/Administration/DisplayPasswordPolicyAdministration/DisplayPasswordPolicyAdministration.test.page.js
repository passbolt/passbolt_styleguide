...
/**
 * The DisplayPasswordPolicyAdministration component represented as a page
 */
export default class DisplayPasswordPolicyAdministrationPage {
  /**
   * Default constructor
    ...
    this._page = render(
      <MockTranslationProvider>
        <AppContext.Provider value={appContext}>
          <AdminPasswordPolicyContextProvider {...props}>
            <DisplayAdministrationPasswordPolicyActions {...props}/>
            <DisplayPasswordPolicyAdministration {...props}/>
   ...
   */
  get passwordPolicy() {
    return this._page.container.querySelector('.password-policy-settings');
  }
  ...
  get passphrasePolicyTitle() {
    return this._page.container.querySelector('#password-policy-settings-title + h4');
  }
  ...
  get passphrasePolicyInput() {
    return this._page.container.querySelector('#password-policy-passphrase-policy-range input');
  }
  ...
  get passphrasePolicyDescription() {
    return this._page.container.querySelector('#password-policy-passphrase-policy-description');
  }
  ...
  get settingsChangedBanner() {
    return this._page.container.querySelector("#password-policy-setting-banner");
  }
   ...
   */
  get title() {
    return this._page.container.querySelector('#password-policy-settings-title');
  }
  /**
   ...
   */
  get passwordPanel() {
    return this._page.container.querySelector('.password-policy-settings .passwords-settings');
  }
   ...
   */
  get passphrasePanel() {
    return this._page.container.querySelector('.password-policy-settings .passphrase-settings');
  }
