...
} from "./DisplayTestUserDirectoryAdministrationDialog.test.data";
import DisplayTestUserDirectoryAdministrationDialogPage from "./DisplayTestUserDirectoryAdministrationDialog.test.page";
...
describe("See the test user directory administration Dialog", () => {
  ...
  describe('As Ad I should see a dialog for my Test settings report', () => {
    ...
    it('As AD I should see the number of user(s) and group(s) founds on the LDAP server in the dialog for my Test settings report', async() => {
      ...
      expect(page.displayTestUserDirectoryAdministrationDialog.usersAndGroupsFound).toBe('12 user(s) and 58 group(s) have been found.');
