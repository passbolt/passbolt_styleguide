  ...
  users: [
    {
      ...
      errors: {
        email: ["user email could not be retrieved"],
        first_name: ["user first name could not be retrieved"],
        last_name: ["user last name could not be retrieved"],
      },
      user: {
        username: null,
        profile: {
  ...
  groups: [
    ...
    },
    {
      ...
      group: {
        ...
        groups: ["CN=Domain Users,CN=Users,DC=passbolt,DC=local"],
        users: [],
      },
    },
    {
      ...
      group: {
        name: "Guests",
        members: ["CN=Domain Guests,CN=Users,DC=passbolt,DC=local", "CN=Guest,CN=Users,DC=passbolt,DC=local"],
        groups: ["CN=Domain Guests,CN=Users,DC=passbolt,DC=local"],
        users: ["CN=Guest,CN=Users,DC=passbolt,DC=local"],
      },
    },
    {
      type: "group",
    ...
    },
    {
      ...
      group: {
        name: "IIS_IUSRS",
        members: ["CN=S-1-5-17,CN=ForeignSecurityPrincipals,DC=passbolt,DC=local"],
        groups: [],
        users: [],
      },
    },
    ...
    },
    {
      ...
      group: {
        ...
        members: ["CN=S-1-5-11,CN=ForeignSecurityPrincipals,DC=passbolt,DC=local"],
        groups: [],
        users: [],
      },
    },
    ...
    },
    {
      ...
      group: {
        ...
        members: ["CN=DefaultAccount,CN=Users,DC=passbolt,DC=local"],
        groups: [],
        users: ["CN=DefaultAccount,CN=Users,DC=passbolt,DC=local"],
      },
    },
    {
      type: "group",
    ...
    },
    {
      ...
      group: {
        name: "Schema Admins",
        members: ["CN=remy,CN=Users,DC=passbolt,DC=local", "CN=Administrator,CN=Users,DC=passbolt,DC=local"],
        groups: [],
        users: ["CN=remy,CN=Users,DC=passbolt,DC=local", "CN=Administrator,CN=Users,DC=passbolt,DC=local"],
      },
    },
    {
      type: "group",
    ...
    },
    {
      ...
      group: {
        ...
        members: ["CN=INSTANCE-1,OU=Domain Controllers,DC=passbolt,DC=local"],
        groups: [],
        users: [],
      },
    },
    {
      ...
      group: {
        name: "Domain Admins",
        members: ["CN=Administrator,CN=Users,DC=passbolt,DC=local"],
        groups: [],
        users: ["CN=Administrator,CN=Users,DC=passbolt,DC=local"],
      },
    },
    {
      type: "group",
    ...
    },
    {
      ...
      group: {
        ...
        members: ["CN=S-1-5-9,CN=ForeignSecurityPrincipals,DC=passbolt,DC=local"],
        groups: [],
        users: [],
      },
    },
    ...
    },
    {
      ...
      group: {
        ...
        users: ["CN=krbtgt,CN=Users,DC=passbolt,DC=local"],
      },
    },
    {
      type: "group",
    ...
    },
    {
      ...
      group: {
        ...
        groups: ["CN=Test1,OU=PassboltUsers,DC=passbolt,DC=local"],
        users: ["CN=Zoe Logos,OU=PassboltUsers,DC=passbolt,DC=local"],
      },
    },
    {
      type: "group",
      ...
      group: {
        ...
        groups: ["CN=Finance,OU=PassboltUsers,DC=passbolt,DC=local"],
        users: [
          "CN=Zoe Logos,OU=PassboltUsers,DC=passbolt,DC=local",
          "CN=Ada Lovelalce,OU=PassboltUsers,DC=passbolt,DC=local",
        ],
    ...
    },
    {
      ...
      group: {
        name: "Test1",
        members: ["CN=Test2,OU=PassboltUsers,DC=passbolt,DC=local"],
        groups: ["CN=Test2,OU=PassboltUsers,DC=passbolt,DC=local"],
        users: [],
      },
    },
    {
      ...
      group: {
        name: "Test2",
        members: ["CN=Ada Lovelalce,OU=PassboltUsers,DC=passbolt,DC=local"],
        groups: [],
        users: ["CN=Ada Lovelalce,OU=PassboltUsers,DC=passbolt,DC=local"],
      },
    },
    {
      type: "group",
