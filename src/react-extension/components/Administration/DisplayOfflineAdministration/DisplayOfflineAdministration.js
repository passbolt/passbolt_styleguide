...
const DEFAULT_OFFLINE_SETTINGS = {
  ...
  data_retention_period: DATA_RETENTION_PERIOD_ALLOWED[1], // 7days
};
              ...
              {this.state.enabled && this.state.settings && (
                <>
                  <div className={`input text input-wrapper ${this.hasAllInputDisabled() ? "disabled" : ""}`}>
                    ...
                    <p>
                      <Trans>
                        How long a user remains authenticated offline before having to enter their passphrase again.
                      </Trans>
                    </p>
                  ...
                  <div className={`input text input-wrapper ${this.hasAllInputDisabled() ? "disabled" : ""}`}>
                    ...
                    <p>
                      <Trans>
                        Maximum time encrypted data is stored on a user&apos;s device before it is automatically
                        deleted.
                      </Trans>
                    </p>
