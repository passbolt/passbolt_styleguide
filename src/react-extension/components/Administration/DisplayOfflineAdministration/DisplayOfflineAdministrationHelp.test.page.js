...
/**
 * The DisplayOfflineAdministrationHelp component represented as a page
 */
export default class DisplayOfflineAdministrationHelpPage {
  /**
   * Default constructor
  ...
  constructor(props) {
    this._page = render(
      <MockTranslationProvider>
        <DisplayOfflineAdministrationHelp {...props} />
      </MockTranslationProvider>,
    );
  }
