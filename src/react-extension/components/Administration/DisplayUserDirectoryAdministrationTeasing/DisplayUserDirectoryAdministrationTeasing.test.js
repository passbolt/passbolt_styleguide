...
describe("DisplayUserDirectoryAdministrationTeasing", () => {
  ...
  it("As CE AD I should see all details about the password policy", async () => {
    ...
    expect(page.usersDirectoryFirstLine).toBe(
      "Simplify user management provisioning through integration with existing directories.",
    );
    ...
    expect(page.helpBoxButton.getAttribute("href")).toBe(
      "https://www.passbolt.com/docs/admin/user-provisioning/users-directory/",
    );
  });
});
