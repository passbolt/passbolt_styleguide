      ...
      <div className="row">
        <div className="ldap-settings-teasing main-column">
          <div className="main-content">
            <h3 className="title" id="ldap-settings-title">
              <Trans>Users Directory</Trans>
              <FrameSVG className="pro-teasing-icon" />
            </h3>
            <p>
              <Trans>Simplify user management provisioning through integration with existing directories.</Trans>
            </p>
            <div className="ldap-settings-info">
              <ul className="ldap-settings-description">
                <li>
                  <RedCheck />
                  <Trans>Automate user onboarding and offboarding.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Sync user attributes efficiently.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Ensure data consistency and security compliance.</Trans>
                </li>
              </ul>
              <div>
                <a
        ...
        {createSafePortal(
          <div className="sidebar-help-section">
            ...
            <a
              className="button"
              href="https://www.passbolt.com/docs/admin/user-provisioning/users-directory/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FileTextSVG />
