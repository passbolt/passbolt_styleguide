      ...
      <div className="row">
        <div className="password-policies-settings-teasing main-column">
          <div className="main-content">
            ...
            <p>
              <Trans>Ensure strong and consistent passwords entropy across your organisation.</Trans>
            </p>
            <div className="password-policies-info">
              <ul className="password-policies-description">
                <li>
                  <RedCheck />
                  <Trans>Reduce the risk of weak passwords.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Enforce complexity requirements.</Trans>
                </li>
                <li>
                  <RedCheck />
                  <Trans>Ensure compliance with internal security standards.</Trans>
                </li>
              </ul>
              <div>
                <a
