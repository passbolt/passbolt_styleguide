  ...
  return {
    context: {
      ...
      userSettings: {
        ...
        getSecurityTokenBackgroundColor: jest.fn(() => "#000"),
        getSecurityTokenTextColor: jest.fn(() => "#fff"),
        getSecurityTokenCode:  jest.fn(() => "Tes")
      },
      port: {
        request: jest.fn()
      }
