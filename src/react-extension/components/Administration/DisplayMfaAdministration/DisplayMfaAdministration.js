      ...
      <div className="row">
        <div className="mfa-settings col7 main-column">
          ...
          <>
            ...
            <div className={`input text required ${errors.yubikeySecretKeyError  && isSubmitted ? "error" : ""} ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
              ...
              <input id="yubikeySecretKey" name="yubikeySecretKey" required="required" className="required fluid form-element" placeholder="**********" type="password"
                onChange={this.handleInputChange} value={settings.yubikeySecretKey} disabled={this.hasAllInputDisabled()} onBlur={e => this.mfaFormService.validateYubikeySecretKey(e.target.value)}/>
          ...
          <>
            ...
            <div className={`input text required ${errors.duoSaltError  && isSubmitted ? "error" : ""} ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
              ...
              <input id="duoSalt" name="duoSalt" required="required" className="required fluid form-element ready" placeholder="**********" type="password"
                value={settings.duoSalt} onChange={this.handleInputChange} disabled={this.hasAllInputDisabled()} onBlur={e => this.mfaFormService.validateDuoSalt(e.target.value)}/>
            ...
            <div className={`input text required ${errors.duoSecretKeyError  && isSubmitted ? "error" : ""} ${this.hasAllInputDisabled() ? 'disabled' : ''}`}>
              ...
              <input id="duoSecretKey" name="duoSecretKey" required="required" className="required fluid form-element ready" placeholder="**********" type="password"
                value={settings.duoSecretKey} onChange={this.handleInputChange} disabled={this.hasAllInputDisabled()} onBlur={e => this.mfaFormService.validateDuoSecretKey(e.target.value)}/>
