		...
		<div class="panel left">
			<div class="navigation wizard">
				<ul>
					...
					<li class="selected">
						<a href="demo/legacy/AN_setup4a0_securitytoken.php">4. Set a security token</a>
					</li>
					<li class="disabled">
						5. Login!
					</li>
				...
				<form>
					...
					<div class="row last">
						<div class="input-wrapper">
							<a href="demo/legacy/AN_setup3b0_importedkeyok.php" class="button cancel big">Cancel</a>
							<a href="demo/legacy/AN_setup5a0_login.php" class="button primary next big">Next</a>
						</div>
					</div>
