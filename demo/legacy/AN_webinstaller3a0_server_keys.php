...
<div id="container" class="page setup">
	...
	<div class="header second">
		...
		<div class="col2_3">
			<h2>Create a new server key or <a href="demo/legacy/AN_webinstaller3a1_server_keys_import.php" class="button primary">Import</a> an existing one</h2>
		</div>
	</div>
						...
						<form>
							...
							<div class="row last">
								<div class="input-wrapper">
									<a href="demo/legacy/AN_webinstaller2a0_database.php" class="button cancel big">Cancel</a>
									<a href="demo/legacy/AN_webinstaller4a0_emails.php" class="button primary next big">Next</a>
								</div>
							</div>
