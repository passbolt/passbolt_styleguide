...
<!--							<a href="demo/legacy/AN_webinstaller3a0_server_keys.php" class="button big disabled">Cancel</a>-->
							<a href="demo/legacy/AN_webinstaller8a0_done.php" class="button big primary">Create user account</a>
						</div>
					</div>
					<div class="col5 last">
