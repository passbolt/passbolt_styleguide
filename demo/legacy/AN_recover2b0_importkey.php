	...
	<div class="panel main ">
		...
		<div class="panel left">
			<div id="js_menu" class="navigation wizard"><ul>
				<li class="">
					<a href="demo/legacy/AN_recover1a1_plugincheckok.php">1. Security checks</a>
				</li>
				<li class="selected">
					<a href="demo/legacy/AN_recover2b0_importkey.php">2. Import your key</a>
				</li>
				<li class="disabled">
			...
			<div class="grid grid-responsive-12">
				...
				<div class="row last">
					<div id="js_step_actions" class="submit-input-wrapper">
						<a class="button primary big js-state-enabled enabled" href="demo/legacy/AN_recover1a1_plugincheckok.php" id="js_setup_cancel_step">Cancel</a>
						<a class="button primary big js-state-disabled disabled" href="demo/legacy/AN_recover4a0_securitytoken.php" id="js_setup_submit_step">Next</a>
					</div>
				</div>
			</div>
		</div>
