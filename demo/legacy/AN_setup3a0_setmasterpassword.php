				...
				<form>
					...
					<div class="row last">
						<div class="input-wrapper">
							<a href="demo/legacy/AN_setup2a0_createnewkey.php" class="button cancel big">Cancel</a>
							<a href="demo/legacy/AN_setup3a1_creatingkeywait.php" class="button primary next big">Next</a>
						</div>
					</div>
