						...
						<form>
								...
								<div class="col5 last">
									<div class="message error side-message">
										...
										<p>
											...
											<a href="demo/legacy/AN_webinstaller3a1_server_keys_import.php">importing another key</a> or
											<a href="demo/legacy/AN_webinstaller3a0_server_keys.php">generating a new one</a>.
										</p>
									</div>
								</div>
							...
							<div class="row last">
								<div class="input-wrapper">
									<a href="demo/legacy/AN_webinstaller3a1_server_keys_import.php" class="button cancel big">Cancel</a>
