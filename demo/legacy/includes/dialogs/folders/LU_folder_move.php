...
<div class="move-folder-dialog dialog-wrapper">
    <div class="dialog">
        <div class="dialog-header">
            ...
            <a class="dialog-close disabled" role="button" href="demo/legacy/LU_passwords_folders.php">
        ...
        <div class="dialog-content">
            ...
            <div class="submit-wrapper clearfix">
              <a class="button primary disabled" href="demo/legacy/LU_folders_move_confirm.php" target="_parent">Move</a>
              <a class="cancel disabled" href="demo/legacy/LU_passwords_folders.php" target="_parent">Cancel</a>
            </div>
        </div>
    </div>
</div>
