					...
					<li id="js_tab_nav_js_rs_edit" class="ready" data-view-id="370">
						<div class="row">
							<div class="main-cell-wrapper">
								<div class="main-cell">
									<a class="selected" href="demo/legacy/LU_passwords_edit.php"><span>Edit</span></a>
								</div>
							</div>
						</div>
						...
						<div class="row selected">
							<div class="main-cell-wrapper">
								<div class="main-cell">
									<a class="" href="demo/legacy/LU_passwords_share.php"><span>Share</span></a>
								</div>
							</div>
						</div>
					</li>
					...
					<form
						...
						<div class="form-content">
							...
							<div class="required js_form_element_wrapper js_form_secret_wrapper">
								...
								<iframe src="demo/legacy/LU_iframe_passwordinput.php?complexity=<?php echo isset($password_complexity) ? $password_complexity : 'fair' ?><?php echo isset($password) ? "&password=$password" : '' ?><?php echo isset($js_field_password_class) ? "&js_field_password_class=$js_field_password_class" : '' ?>" id="passbolt-iframe-secret-edition"
						...
						<div class="submit-wrapper clearfix">
							...
							<a href="demo/legacy/LU_passwords.php" class="js-dialog-cancel cancel">Cancel</a>
						</div>
					</form>
				</div>
			</div>
