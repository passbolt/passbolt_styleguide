...
- The user CN=Zoe Logos,OU=PassboltUsers,DC=passbolt,DC=local could not be added to group Operations because there is no matching directory entry in passbolt.
		...
		<div class="submit-wrapper clearfix">
			<a class="button primary" href="demo/legacy/AD_admin_ldap_synchronize.php">Synchronize</a>
			<a class="js-dialog-cancel cancel" href="demo/legacy/AD_admin_ldap_configuration.php">Cancel</a>
		</div>
		</div>
	</div>
</div>