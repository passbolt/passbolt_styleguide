<div id="a484a5eb-4258-bde9-6b1e-20c6f26204fb" class="dialog-wrapper ready">
	<div class="dialog ldap-synchronise">
		<div class="dialog-header">
			<h2>Synchronize report</h2>
			<a href="demo/legacy/AD_admin_ldap_configuration.php" class="dialog-close" role="button">
		...
		<div class="form-content">
			<p><strong>The synchronize was successfull</strong></p>
			<p>4 users and 4 groups were synchronized.</p>
...
- The user CN=Zoe Logos,OU=PassboltUsers,DC=passbolt,DC=local could not be added to group Operations because there is no matching directory entry in passbolt.
		...
		<div class="submit-wrapper clearfix">
			<a class="button primary" href="demo/legacy/AD_admin_ldap_synchronize.php">OK</a>
		</div>
		</div>
	</div>
</div>