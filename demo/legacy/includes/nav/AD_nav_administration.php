	...
	<ul class="clearfix passbolt_controller_component_preference_menu_controller mad_view_component_tree menu ready"
		...
		<li>
			<div class="row <?php echo isselected('mfa'); ?>">
				<div class="main-cell-wrapper">
					<div class="main-cell">
						<a href="demo/legacy/AD_admin_mfa_configuration.php"><span>Multi Factor Authentication</span></a>
					</div>
				</div>
			</div>
		</li>
		<li>
			<div class="row <?php echo isselected('ldap_configuration'); ?>">
				<div class="main-cell-wrapper">
					<div class="main-cell">
						<a href="demo/legacy/AD_admin_ldap_configuration.php"><span>User directory</span></a>
					</div>
				</div>
			</div>
		</li>
		<li>
			<div class="row <?php echo isselected('email_notifications'); ?>">
				<div class="main-cell-wrapper">
					<div class="main-cell">
						<a href="demo/legacy/AD_admin_email_notifications.php"><span>Email notifications</span></a>
					</div>
				</div>
			</div>
		</li>
		<li>
			<div class="row <?php echo isselected('smtp'); ?>">
				<div class="main-cell-wrapper">
					<div class="main-cell">
						<a href="demo/legacy/AD_admin_smtp_configuration.php"><span>Email transport</span></a>
					</div>
				</div>
			</div>
		</li>
		<li>
			<div class="row <?php echo isselected('shared_tags'); ?>">
				<div class="main-cell-wrapper">
					<div class="main-cell">
						<a href="demo/legacy/AD_admin_shared_tags.php"><span>Tags taxonomy</span></a>
					</div>
				</div>
			</div>
		</li>
