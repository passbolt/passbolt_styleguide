	...
	<div class="grid">
		<div class="row">
			<div class="col6 push1 information">
				...
				<p>You can <a href="demo/legacy/AN_register.php">register again</a> for this domain, or <a href="demo/legacy/AN_recover.php">recover an existing account</a>
			...
			<div class="col4 push1 last">
				...
				<div class="users login form">
					...
					<div class="actions-wrapper center">
						<a class="button primary big" href="demo/legacy/AN_login_stage0.php">Register for this domain</a><br><br>
						<a href="demo/legacy/AN_recover.php">or recover an existing account</a>
					</div>
				</div>
			</div>
		</div>
