	...
	<div class="panel main ">
		...
		<div class="panel left">
			<div class="navigation wizard">
				<ul>
					<li class="selected">
						<a href="demo/legacy/AN_setup1a0_plugincheckfail.php">1. Get the plugin</a>
					</li>
					<li class="disabled">
						2. Define your keys
					</li>
					...
					<div class="col7">
						<div class="plugin-check-wrapper">
							...
							<div class="plugin-check firefox warning">
								<p class="message">
									<strong>Warning:</strong> The plugin is already configured for John Doe (john.doe@passbolt.com), on domain https://demo.passbolt.com.
									Completing this setup again will prevent John Doe to access his passbolt account with this browser.
								</p>
							</div>
						</div>
						<div class="why-plugin-wrapper">
							...
							<form>
								...
								<div class="input text disabled">
									...
									<a href="demo/legacy/AN_setup1a1_plugincheckok_keyinformation.php" class="more" id="js_server_key_info">More</a>
								</div>
								...
								<div class="submit-input-wrapper">
									<a href="demo/legacy/AN_setup2a0_createnewkey.php" class="button primary big disabled">Next</a>
								</div>
							</form>
						</div>
					</div>
