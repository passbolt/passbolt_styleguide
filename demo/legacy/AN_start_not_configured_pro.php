            ...
            <div class="row">
                <div class="col6">
                    <div class="big-choice">
                        ...
                        <a href="https://help.passbolt.com/hosting/install" class="dim button"><i class="fa fa-cogs fa-fw"></i>  Follow the documentation</a>
                    </div>
                </div>
                <div class="col6 last">
                    <div class="big-choice">
                        ...
                        <p>
                            Choose this option if you want to be guided by the configuration wizard and get started in no time.
                        </p>
                        <a href="#" class="button primary"><i class="fa fa-magic fa-fw"></i> Start the wizard</a>
                    </div>
                </div>
            </div>
        </div>
