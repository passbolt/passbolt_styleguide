						...
						<form>
							...
							<div class="row last">
								<div class="input-wrapper">
									<a href="demo/legacy/AN_webinstaller1a1_systemcheck_success.php" class="button cancel big">Cancel</a>
									<a href="demo/legacy/AN_webinstaller2a0_database.php" class="button primary next big">Next</a>
								</div>
							</div>
