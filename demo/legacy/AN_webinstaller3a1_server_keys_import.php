...
<div id="container" class="page setup">
	...
	<div class="header second">
		...
		<div class="col2_3">
			<h2 id="js_step_title">Import an existing key or <a class="button primary" href="demo/legacy/AN_webinstaller3a0_server_keys.php" id="js_setup_goto_define_key">Create</a> a new one!</h2>
		</div>
	</div>
						...
						<form>
							...
							<div class="row last">
								<div class="input-wrapper">
									<a href="demo/legacy/AN_webinstaller3a0_server_keys.php" class="button cancel big">Cancel</a>
									<a href="demo/legacy/AN_webinstaller3a1_server_keys_import_error.php" class="button primary next big">Next</a>
								</div>
							</div>
