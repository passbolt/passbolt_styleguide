...
<div id="container" class="page iframe mfa">
    <div class="grid grid-responsive-12">
        <div class="grid grid-responsive-12">
            <form method="post" class="totp-setup" accept-charset="utf-8" action="demo/legacy/iframes/LU_iframe_totp_setup_post_success.php">
                ...
                <div class="row">
                    <div class="col7">
                        <div class="actions-wrapper">
                            <a href="demo/legacy/iframes/LU_iframe_totp_setup_start.php" class="button cancel">Cancel</a>
