			...
			<div class="col6 push1 information">
				...
				<div class="plugin-check-wrapper">
					<div class="plugin-check firefox warning">
						<p class="message">Firefox plugin is installed but is not configured. <a href="demo/legacy/AN_register.php">Register</a> or <a href="demo/legacy/AN_recover.php">recover your account</a> if you already have one!</p>
					</div>
				</div>
				<p>
			...
			<div class="col4 push1 last">
				...
				<div class="users login form">
					...
					<div class="actions-wrapper center">
						<a class="button primary big" href="demo/legacy/AN_login_stage0.php">Register</a>
						<a href="demo/legacy/AN_recover.php">Have an account?</a>
					</div>
				</div>
			</div>
		</div>
