		...
		<div class="panel left">
			<div class="navigation wizard">
				<ul>
					...
					<li class="">
						<a href="demo/legacy/AN_setup2a0_createnewkey.php">2. Define your keys</a>
					</li>
					<li class="selected">
						<a href="demo/legacy/AN_setup3a0_setmasterpassword.php">3. Set a passphrase</a>
					</li>
					<li class="disabled">
			...
			<div class="grid grid-responsive-12">
					...
					<div class="col7">
						<div class="plugin-check-wrapper">
							...
							<div class="success message backup-prompt">
								<a href="demo/legacy/AN_setup4a0_securitytoken.php" class="button primary next big">
				...
				<div class="row last">
					<div class="input-wrapper">
						<a href="demo/legacy/AN_setup3a0_setmasterpassword.php" class="button cancel big">Cancel</a>
						<a href="demo/legacy/AN_setup4a0_securitytoken.php" class="button primary next big">Next</a>
					</div>
				</div>
			</div>
		</div>
