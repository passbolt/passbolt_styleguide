...
<div id="container" class="page setup">
	...
	<div class="header second">
		...
		<div class="col2_3">
			<h2>Create a new key or <a href="demo/legacy/AN_setup2b0_importkey.php" class="button primary">Import</a> an existing one</h2>
		</div>
	</div>
		...
		<div class="panel middle">
			<div class="grid grid-responsive-12">
				<form>
					...
					<div class="row last">
						<div class="input-wrapper">
							<a href="demo/legacy/AN_setup1a1_plugincheckok.php" class="button cancel big">Cancel</a>
							<a href="demo/legacy/AN_setup3a0_setmasterpassword.php" class="button primary next big">Next</a>
						</div>
					</div>
