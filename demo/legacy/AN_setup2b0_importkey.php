			...
			<div class="grid grid-responsive-12">
				...
				<div class="row last">
					<div id="js_step_actions" class="submit-input-wrapper">
						<a class="button primary big js-state-enabled enabled" href="demo/legacy/AN_setup1a1_plugincheckok.php" id="js_setup_cancel_step">Cancel</a>
						<a class="button primary big js-state-disabled disabled" href="demo/legacy/AN_setup3b1_importedkeywarn.php" id="js_setup_submit_step">Next</a>
					</div>
				</div>
			</div>
		</div>
