					...
					<div class="col7">
						<div>
							...
							<p>
								...
								<a href="/privacy">https://www.passbolt.com/privacy</a>.
							</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col7">
						<div>
							...
							<p>
								If you provided us with contact details we shall notify by email about any changes in these terms of service. If you did not
								provide us with contact details you acknowledge and agree that it is your responsibility to review the Site and these terms of
				...
				<div class="row">
					...
					<div class="col5 last">
						<div class="tldr">
							<h4 class="visuallyhidden">Modification (Summary)</h4>
							<p>
								<i class="fa fa-certificate"></i> No warranty
							</p>
							<p>
						...
						<div class="col7">
							...
							<div>
								...
								<p>
									...
									by the laws of India, without regard to the conflicts of laws provisions therein.
								</p>
							</div>
							<div>
