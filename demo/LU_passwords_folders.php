...
<?php include('includes/leftpanel/LU_passwords_folders_contextual_menu.php'); ?>
...
<?php include('includes/nav/LU_nav_folders_tree_contextual_menu.php'); ?>
<?php include('includes/headers/LU_header_announcement.php'); ?>
<div id="container" class="page password">
    ...
    <?php include('includes/workspace/LU_passwords_folders_workspace.php'); ?>
	</div>
</div>
