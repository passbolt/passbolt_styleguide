                                ...
                                <div class="grid grid-responsive-12">
                                            ...
                                            <div class="input-verify">
                                                <div class="input text required error">
                                                    ...
                                                    <div id="js_field_name_feedback"
                                                         class="message error ready">
                                                        This code is not valid. Maybe it already expired. Please try again.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="actions-wrapper">
                                            ...
                                            <a class="button primary big" href="../demo/LU_users_profile_mfa_03.php">Validate</a>
                                        </div>
                                    </div>
                                </div>
                                </form>
