        ...
        <div id="app" class="app" tabindex="1000">
            <div class="dialog-wrapper">
                <div class="dialog create-password-dialog">
                    <div class="dialog-header"><h2>Create a password</h2><a class="dialog-close"><span class="fa icon"><svg
                    ...
                    <div class="dialog-content">
                        <form novalidate="">
                            <div class="form-content">
                                ...
                                <div class="input-password-wrapper required "><label
                                    ...
                                    <div class="input text password"><input id="create-password-form-password"
                                                ...
                                                type="password" value="yW?&amp;9kk8^}uR99Uzt0">
                                    ...
                                    <div class="password-complexity strong"><span class="progress"><span
                                                    class="progress-bar strong"></span></span><span
                                                class="complexity-text">complexity: <strong>strong</strong></span></div>
                                </div>
