                        ...
                        <form novalidate="">
                            <div class="form-content">
                                ...
                                <div class="input text">
                                    ...
                                    <input id="create-password-form-uri" name="uri" class="fluid" maxlength="1024" type="text" vautocomplete="off" alue="">
                                </div>
                                <div class="input text">
                                ...
                                <div class="input-password-wrapper required input error">
                                    ...
                                    <div class="input text password">
                                        ...
                                        <div class="security-token" style="background: rgb(255, 58, 58) none repeat scroll 0% 0%; color: rgb(255, 255, 255);">ADM</div>
                                    </div>
                            ...
                            <div class="submit-wrapper clearfix">
                                ...
                                <a class="cancel" focusable="true">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
