<div class="edit-folder-dialog mad_controller_component_dialog_controller mad_view_component_dialog dialog-wrapper ready">
	<div class="dialog">
		<div class="dialog-header">
			<h2>Edit<span class="dialog-header-subtitle">Plants</span></h2>
		...
		<div class="js_dialog_content dialog-content">
          ...
          <form id="js_folder_create_form" class="edit-form passbolt_form_folder_create folder_create_form form mad_view_form ready">
              <div class="form-content edit-form">
                  <div class="input text required clearfix js_form_element_wrapper">
                      ...
                      <input name="passbolt.model.Folder.name" class="required mad_form_textbox form-element mad_view_form_textbox ready" maxlength="50" id="js_field_name" placeholder="folder name" type="text" value="Plants">
