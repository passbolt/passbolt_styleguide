    ...
    <div class="tableview-content scroll">
        <table>
            ...
            <tr class="<?php if (!$i) echo 'selected'; ?>" id="resource<?= $folder['id']; ?>">
                ...
                <td class="js_grid_column_icon grid_column_icon grid_column_icon s1-cell cell_icon">
                    <div title="">
                ...
                <td class="js_grid_column_username cell_username m-cell"></td>
                <td class="js_grid_column_secret cell_secret m-cell password"></td>
                <td class="js_grid_column_uri cell_uri l-cell"></td>
