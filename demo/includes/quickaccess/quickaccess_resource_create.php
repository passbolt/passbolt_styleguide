<div class="container page quickaccess">
    ...
    <div class="resource-create">
        <div class="back-link">
            <a href="#" class="primary-action">
               <span class="icon fa">
                ...
                <span class="primary-action-title">Create password</span>
            </a>
        ...
        <div class="resource-create-form" data-simplebar>
            <div class="form-container">
                <div class="input text required error">
                    <label for="UserUsername">Name</label>
                    <input name="data[Resource][Name]" class="required fluid" maxlength="50" type="text" id="ResourceName" required="required" >
                    <div class="error-message">This field is required.</div>
                </div>
                <div class="input text">
                    <label for="UserUsername">URI</label>
                    <input name="data[Resource][uri]" class="required fluid" maxlength="50" type="text" id="ResourceUri" required="required">
                </div>
                <div class="input text">
                    <label for="UserUsername">Username</label>
                    <input name="data[Resource][username]" class="required fluid" maxlength="50" type="text" id="ResourceUsername" required="required">
                </div>
                <div class="input text password required">
                    <label for="passphrase">Password</label>
                    <input type="password" placeholder="Password" id="password">
                    <a href="#" class="password-view button-icon button button-toggle ">
                        <span class="svg-icon">
                    ...
                    <a href="#" class="password-generate button-icon button">
                        <span class="svg-icon">
                    ...
                    <span class="password-strength">
                        <span class="password-strength-bar"><span class="password-strength-bar-value weak"></span></span>
                        <span class="password-strength-label">Strength:</span>
                        <span class="password-strength-value">poor</span>
                    </span>
                </div>
        ...
        <div class="submit-wrapper">
            <a id="loginSubmit" href="#" class="button primary big full-width" role="button">Save</a>
        </div>
    </div>
</div>