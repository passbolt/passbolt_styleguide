<div class="panel aside js_wsp_pwd_sidebar_second passbolt_component_resource_sidebar js_component passbolt_view_component_resource_sidebar ready"
    ...
    <div class="sidebar resource">
      <div class="sidebar-header">
        ...
        <h3>
          <span class="name">Plants
            <a class="title-link" title="Copy the link to this folder">
                ...
                <span class="visuallyhidden">Copy the link to this folder</span>
            </a>
          </span>
        ...
        <?php include('includes/sidebars/sections/folders_info.php'); ?>
        <?php include('includes/sidebars/sections/folders_shared.php'); ?>
        <?php include('includes/sidebars/sections/folders_activity.php'); ?>
    </div>
</div>
