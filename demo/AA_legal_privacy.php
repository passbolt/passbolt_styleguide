					...
					<div class="row">
						<div class="col7">
							<div>
								...
								<h4>Analytics</h4>
								<p>
									We use <a href="http://piwik.org/" target="_blank" rel="nofollow">Piwik</a> to collect information about your usage of the Site, such as which page you visited, how long you stayed on the Site, etc.
								...
								<p>
									The Demo Site itself collect information about your usage, such as when you created or edited a password, when you posted a comment, when you triggered a system error, etc.
									This is needed to provide functionalities such as access and control logs within the application.
					...
					<div class="row">
						...
						<div class="col5 last">
							<div class="tldr">
								...
								<p>
									<i class="fa fa-thumbs-o-up"></i> No proprietary javascript
								</p>
								<p>
									<i class="fa fa-thumbs-o-up"></i> No 3rd party tracking
								</p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col7">
							<div>
								...
								<h4>Governments</h4>
								<p>
									Our organization is registered in India. Therefore, we are obliged to comply with the Government of India lawful interception requests pursuant to the <a href="www.dot.gov.in/act-rules/indian-telegraph-rule-2008" target="_blank" rel="nofollow">Rule 419A of Indian Telegraph Rules</a>.
								</p><p>
								...
								<p>
									...
									See AWS <a href="https://aws.amazon.com/legal/" target="_blank" rel="nofollow">legal framework</a>.
								</p><p>
								<h4>Newsletter provider</h4>
								<p>
									We use Mailchimp to send newsletters.<br>
									See Mailchimp <a href="http://mailchimp.com/legal/" target="_blank" rel="nofollow">legal framework</a>.
								</p>
								<h4>Help desk provider</h4>
								<p>
									We use Zendesk to provide support by email or on social networks.<br>
									See Zendesk <a href="https://www.zendesk.com/company/privacy/" target="_blank" rel="nofollow">privacy policy</a>.
								</p>
								<h4>Analytics</h4>
								<p>
									We use Piwik Cloud Pro for analytics.<br>
									See the privacy section in the Piwik <a href="https://cloud.piwik.pro/tos/" target="_blank" rel="nofollow">terms of services</a>.
								</p>
							</div>
						</div>
						<div class="col5 last">
							<div class="tldr">
								...
								<p>
									<i class="fa fa-info-circle"></i> Indian law apply
								</p>
								<p>
									<i class="fa fa-thumbs-o-down"></i> Digital Millennium Act
								</p>
								<p>
						...
						<div class="col7">
							<div>
								...
								<p>
									...
									You may also contact us to edit or delete your personal information. Unless it’s prohibited by law, we’ll remove or edit any of your personal information from our servers at your request.
								</p><p>
							...
							<div>
								...
								<p>
									This privacy policy was last updated on February 4th, 2016.
								</p>
							</div>
						</div>
						<div class="col5 last">
