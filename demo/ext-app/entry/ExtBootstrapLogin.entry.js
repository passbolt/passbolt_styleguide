...
/**
 * This is a demo entry point that has for aim to instantiate the login application served by the
...
import ExtBootstrapLogin from "../../../src/react-extension/ExtBootstrapLogin";
...
ReactDOM.render(<ExtBootstrapLogin port={mockedPort} storage={mockedStorage} browserExtensionUrl={browserExtensionUrl}/>, domContainer);
