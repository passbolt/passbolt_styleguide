...
<div id="container" class="page password">
    ...
    <div id="js_app_controller" class="passbolt_controller_app_controller mad_view_view js_component ready">
        <iframe id="react-app" src="demo/iframes/LU_passwords_create.php" frameborder="0" style="display: block; position: absolute; width: 100%; height: 100%; z-index: 999;"></iframe>
