...
export default storage => {
  ...
  mockPort.addRequestListener("passbolt.site-settings.get-or-find", mockRequestSiteSettings);
  mockPort.addRequestListener("passbolt.site-settings.find-and-update", mockRequestSiteSettings);
